                ...
                localStorage.getItem('admin') ?
                  <>
                    ...
                    <LinkContainer to="/Crud">
                      <li className="nav-item">
                        <a className="nav-link" href="product.html" >Crud</a>
                      </li>
                    </LinkContainer>
                    ...
                    <LinkContainer to="/LoginPage">
                      <li className="nav-item">
                        <a className="nav-link" href="product.html" onClick={handleLogout}>Logout</a>
                      </li>
                    </LinkContainer>
                  </>
                  ...
                  : localStorage.getItem('user') ?
                    <>
                        ...
                        <li className="nav-item">
                          <a className="nav-link" href="#">Hello-{detail.username} </a>
                        </li>
                      ...
                      <LinkContainer to="/products">
                        <li className="nav-item">
                          <a className="nav-link" href="blog_list.html">Product</a>
                        </li>
                      </LinkContainer>
                    ...
                    <>
                      ...
                      <LinkContainer to="/SignUp">
                        <li className="nav-item">
                          <a className="nav-link" href="Login.html">SignUp</a>
                        </li>
                      </LinkContainer>
                    </>
